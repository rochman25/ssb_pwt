            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endcomponent
                        <form action="{{ route('student_payments.update',$payment->id) }}" method="POST">
                            @csrf
                            @method("PUT")
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="student_id" class="js-example-basic-single col-sm-12">
                                        ...
                                        @foreach ($students as $item)
                                            <option value="{{ $item->id }}" @if (old('student_id',$payment->student_id) == $item->id) selected @endif>{{ $item->fullname }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        id="validationServer04" name="payment_date" value="{{ old('payment_date',$payment->payment_date) }}" required="">
                                    @error('payment_date')
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        id="validationServer04" name="amount" value="{{ old('amount',$payment->amount) }}" required="">
                                    @error('amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        @foreach ($status as $item)
                                            <option value="{{ $item }}" @if (old('status',$payment->status) == $item) selected @endif>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('estimate_time')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea
                                        ...
                                        required="">{{ old('description',$payment->description) }}</textarea>
                                </div>
                            </div>
