                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="validationServer04" name="code" value="{{ old('code',$schedule->code) }}" required="">
                                    @error('code')
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="class_instructor_id" class="js-example-basic-single col-sm-12">
                                        ...
                                        @foreach ($classes as $item)
                                            <option value="{{ $item->id }}" @if (old('class_instructor_id',$schedule->class_instructor_id) == $item->id) selected @endif>{{ $item->class->name . '-' . $item->instructor->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="month"
                                        ...
                                        id="validationServer04" name="month" value="{{ old('month',$schedule->month) }}" required="">
                                    @error('month')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        id="validationServer04" name="week" value="{{ old('week',$schedule->week) }}" required="">
                                    @error('week')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        id="validationServer04" name="estimate_time" value="{{ old('estimate_time',$schedule->estimate_time) }}" required="">
                                    @error('estimate_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col">
                                        <div class="form-group m-t-15 m-checkbox-inline mb-0">
                                            @php($selectedDays = explode(",",$schedule->days))
                                            @foreach ($days as $index => $item)
                                                <div class="checkbox checkbox-dark">
                                                    <input id="inline-{{ $index }}" name="days[]" value="{{ $item }}" @if(in_array($item,$selectedDays)) checked @endif type="checkbox">
