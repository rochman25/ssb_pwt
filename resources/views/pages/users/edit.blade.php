                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control @error('username') is-invalid @enderror" name="name"
                                        id="validationServer01" type="text" value="{{ old('name',$user->name) }}" required="">
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control @error('username') is-invalid @enderror"
                                        id="validationServer02" type="text" value="{{ old('username',$user->username) }}" name="username"
                                        required="">
                                    @error('username')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control form-control @error('email') is-invalid @enderror"
                                        id="validationServer03" type="email" name="email" value="{{ old('email',$user->email) }}"
                                        required="">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select
                                        ...
                                        @foreach ($roles as $item)
                                            <option value="{{ $item->id }}" @if (old('role',$user->roles->first()->id ?? "") == $item->id) selected @endif>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('role')
